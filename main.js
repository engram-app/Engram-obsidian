...
var BINARY_EXTENSIONS = /* @__PURE__ */ new Set([
  ...
  isCrdtManagedOffline(path, noteId) {
    return !!this.crdt && !!noteId && this.isNoteConfirmed(noteId) && this.isLiveBound((0, import_obsidian21.normalizePath)(path));
  }
  ...
  async applyChange(change, forceOverwrite = !1) {
        ...
        if (change.content_hash && (stored == null ? void 0 : stored.serverHash) !== change.content_hash)
          if (this.isLiveBound(normalized)) {
            ...
            if (rlog().warn(
              ...
              let boundFile = this.app.vault.getFileByPath(normalized), localHash = (_f = stored == null ? void 0 : stored.hash) != null ? _f : boundFile ? fnv1a(await this.app.vault.cachedRead(boundFile)) : 0;
              this.syncState.set(normalized, {
                hash: localHash,
                serverHash: change.content_hash,
                version: change.version
    ...
    if (existing) {
      ...
      if (!forceOverwrite && localModified && localContent !== content) {
        ...
        let pullBase = (_g = this.baseStore) == null ? void 0 : _g.get(normalized);
        if (pullBase) {
          ...
          if (merge2.clean) {
            await this.modifyFile(existing, merge2.merged), this.syncState.set(normalized, {
              hash: fnv1a(merge2.merged),
              version: change.version
            }), change.version != null && ((_h = this.baseStore) == null || _h.set(normalized, merge2.merged, change.version));
            try {
        ...
        return devLog().log("pull", `applyChange SKIP (identical): ${change.path}`), this.syncState.set(normalized, {
          ...
          version: change.version,
          serverHash: change.content_hash
        }), change.version != null && ((_k = this.baseStore) == null || _k.set(normalized, content, change.version)), rlog().info("pull", `Unchanged: ${change.path}`), !1;
      return devLog().log("pull", `applyChange OVERWRITE: ${change.path} (len=${content.length})`), await this.modifyFile(existing, content), this.syncState.set(normalized, {
        ...
        version: change.version,
        serverHash: change.content_hash
      }), change.version != null && ((_l = this.baseStore) == null || _l.set(normalized, content, change.version)), rlog().info(
        "pull",
    ...
    return this.syncState.set(normalized, {
      ...
      version: change.version,
      serverHash: change.content_hash
    }), change.version != null && ((_m = this.baseStore) == null || _m.set(normalized, content, change.version)), rlog().info("pull", `Created: ${change.path} | len=${content.length}`), !0;
  }
