...
function createCrdtWiring(deps) {
  ...
  let enrollment = new CrdtEnrollment({
    ...
    syncEngine.isSyncBlocked() || enrollment.enroll(docId);
  };
  function dispose() {
  ...
  connectChannel(attempt = 0, epoch = this.channelEpoch) {
    ...
    rlog().info(
      ...
      if (channel.setAuthProbe(() => this.api.getMe()), channel.onEvent = (event) => {
        ...
        this.crdtWiring = wiring, this.crdtManager = wiring.manager, this.crdtChannel = wiring.channel, this.crdtEnrollment = wiring.enrollment, this.syncEngine.setCrdtEnrollment(this.crdtEnrollment), this.crdtLiveViews = new CrdtLiveViews({
          app: this.app,
        ...
        ), this.crdtLiveViews.refresh(), channel.onCrdtMessage = wiring.onCrdtMessage, channel.onCrdtDocReady = wiring.onCrdtDocReady, channel.onCrdtJoined = () => {
          rlog().info(
            "crdt",
