...
describe("pull un-masking — CRDT-owned local note must catch up from /changes", () => {
	...
	test("D2 regression: a fresher live-merged Y.Doc survives a stale/checkpoint-lagged feed snapshot " +
		"(docs/context/d2-seq-replay-stale-snapshot-stomp.md)", async () => {
